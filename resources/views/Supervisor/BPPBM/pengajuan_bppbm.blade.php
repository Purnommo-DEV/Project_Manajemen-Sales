...
@section('script')
    <script>
        ...
        const table_data_perjalanan = $('#table-data-perjalanan').DataTable({
            ...
            "sScrollXInner": "100%",
            ajax: {
                url: "{{ route('supervisor.DataPerjalanan') }}",
                type: "POST",
                headers: {
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row, meta) {
                        daftar_data_perjalanan[row.id] = row;
                        if (row.alamat_wal == null) {
                            return `<p>belum ditentukan`
                        } else {
                            return row.alamat_wal;
                        }
                    }
                },
                {
                ...
                },
                {
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        tampilan = `
                            <div class="ms-auto">
                                <a class="btn btn-link text-warning text-gradient px-3 mb-0" href="/supervisor/detail-pengajuan-bppbm/${row.kode}"><i class="fa fa-eye me-2"></i>Detail</a>
                            </div>
                                `
                        return tampilan;
                    }
