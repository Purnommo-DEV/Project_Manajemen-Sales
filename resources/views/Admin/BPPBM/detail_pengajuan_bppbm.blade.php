                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    <input type="text" class="form-control" id="inputtext"
                                        value="{{ $perjalanan->km_awal }}" placeholder="text">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    <input type="text" class="form-control" id="inputtext"
                                        value="{{ $perjalanan->km_akhir }}" placeholder="text">
                                </div>
                            </div>
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        tampilan = `
                            <div class="ms-auto">
                                <a class="btn btn-link text-dark text-gradient px-3 mb-0" href="/admin/detail-bppbm-customer/${row.id}">
