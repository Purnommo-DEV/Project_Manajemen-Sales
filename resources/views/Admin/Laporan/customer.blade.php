@extends('Layout.master', ['title' => 'Data Laporan Customer'])
@section('nav')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Data Laporan Customer/</a>
            </li>
        </ol>
        <h6 class="font-weight-bolder mb-0">Data Laporan Customer</h6>
    </nav>
@endsection
@section('konten')
...
@section('script')
    <script>
        ...
        const table_data_customer = $('#table-data-customer').DataTable({
            ...
            "sScrollXInner": "100%",
            ajax: {
                url: "{{ route('admin.DataLaporanCustomer') }}",
                type: "POST",
                headers: {
